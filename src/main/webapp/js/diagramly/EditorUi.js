      ...
      try {
        ...
        var renderCallback = mxUtils.bind(this, function (svg) {
          try {
            ...
            if (mxClient.IS_IE || mxClient.IS_IE11) {
              svg = svg.replace(/ xmlns:\S*="http:\/\/www.w3.org\/XML\/1998\/namespace"/g, '').replace(/ (NS xml|\S*):space="preserve"/g, ' xml:space="preserve"');
            }
          ...
          if (force || document.body.contains(picker)) {
            ...
            if (!collapsed) {
              ...
              if (value != 'simple' || iw >= 660) {
                ...
                addElt(textElt, mxResources.get('text') + ' (A)', null, 'A', 32).style.margin = (value == 'simple') ?
                  '0 -8px 0 0' : '0 0 0 -2px';
              }
              ...
              if (value == 'simple') {
                ...
                addElt(this.sidebar.createEdgeTemplateFromCells([cell],
                  ...
                  mxResources.get('arrow')).style.margin = em;
