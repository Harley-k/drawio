...
(function () {
  ...
  Menus.prototype.init = function () {
    ...
    lightModeAction.setSelectedCallback(function () {
      return !Editor.isAutoDarkMode(true) && !Editor.isDarkMode();
    });
    ...
    autoModeAction.setSelectedCallback(function () {
      return Editor.isAutoDarkMode(true);
    });
...
/* 删除主题
    ...
    this.put('view', new Menu(mxUtils.bind(this, function (menu, parent) {
      if (Editor.currentTheme == 'simple') {
        ...
        this.addMenuItems(menu, (['format', 'outline', 'layers', 'tags']).concat((editorUi.commentsSupported()) ?
          ['comments', '-'] : ['-']));
      ...
      if (sketchTheme || uiTheme == 'min') {
        ...
        if (urlParams['newTempDlg'] == '1') {
          editorUi.actions.addAction('templates', function () {
            ...
            var tempDlg = new TemplatesDialog(editorUi, function (xml) {
