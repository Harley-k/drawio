...
(function () {
  ...
  Editor.commonEdgeProperties = [
    ...
    {name: 'arcSize', dispName: 'Arc Size', type: 'float', min: 0, defVal: mxConstants.LINE_ARCSIZE},
    {
      ...
      enumList: [{val: 'none', dispName: 'None'}, {val: 'north', dispName: 'North'}, {
        val: 'east',
        dispName: 'East'
      }, {val: 'south', dispName: 'South'}, {val: 'west', dispName: 'West'}]
    },
    {
  ...
  if (window.StyleFormatPanel != null) {
    ...
    mxCellRenderer.defaultShapes['tableRow'].prototype.customProperties =
      mxCellRenderer.defaultShapes['swimlane'].prototype.customProperties.concat(mxCellRenderer.defaultShapes['partialRectangle'].prototype.customProperties);
